                                        ...
                                        <tr>
                                            ...
                                            <td class="column_product_info">
                                                ...
                                                <div class="cart_item__details">
                                                    <p class="c_item_price">Price Rs: <del class="p-prc mr-2"><?= $rs->regular_price?></del><span class="p-prc mr-2"><?= $rs->offer_price?></span></p>
                                            ...
                                            <td class="column_total">
                                                <span class="money" data-currency-usd="$15.00"><?php echo $ds->subtotal; ?></span>
                                            </td>
                                            ...
                                            <td class="column_quantity">
                                                <div class="product-qty">
                                                    <div class="qty-choose flex-container">
                                                        <?php if($ds->qty==1):?>
                                                       <a class="product-quantity" href="<?= base_url('cart/loginmincart/'.$ds->rowid.'/'.$ds->qty)?>" style="pointer-events: none;
                                                               cursor: default;">
                                                            <i class="fa fa-minus" aria-hidden="true"></i>
                                                        </a>
                                                    <?php else: ?>
                                                    <a class="product-quantity" href="<?= base_url('cart/loginmincart/'.$ds->rowid.'/'.$ds->qty)?>">
                                                            <i class="fa fa-minus" aria-hidden="true"></i>
                                                        </a>
                                                    <?php endif?>
                                                        <div>
                                                        ...
                                                        <a class="product-quantity" href="<?= base_url('cart/loginaddcart/'.$ds->rowid.'/'.$ds->qty)?>">
                                            ...
                                            <td class="column_remove">
                                                <a class="icon-bin-delete" title="Delete" href="<?= base_url('cart/logindelete/'.$ds->rowid)?>"></a>
                                            </td>
                                        </tr>
