...
<head>
	...
	<style type="text/css">
	.link-sec .col-lg-4.col-md-6.col-sm-6{
		margin: 0;
		padding: 0;
	}
	img.img-fluid {
	...
	<section class="link-sec">
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="img-block third">
						<a href="">
							<img src="<?= base_url('assets/images/m3.png')?>" alt="" class="img-fluid">
							<div class="overlay-text">
								<!-- <h5>Motoexperience</h5> -->
								<a href="<?= base_url('motoexprience/ride')?>"><img class="mx-auto d-block" src="<?= base_url('assets/images/motoexperience.png')?>"></a>
							</div>
						</a>
					</div>
				</div>
